    ...
    this.http.post<any>(`${this.url}/postOwners`,obj).subscribe(data => {
      ...
      if(this.ownerandboatdetails[0].BoatDetails[0].Boat_Status=="1"){
        this.boatStatus = "Enable"
           ...
           this.TotalDaysAssigned_Summer_WeekDays = this.ownerandboatdetails[0].BoatDetails[0].Summer_WeekDays;
           this.TotalDaysAssigned_Summer_WeekEndDays = this.ownerandboatdetails[0].BoatDetails[0].Summer_WeekEndDays;
           this.TotalDaysAssigned_Winter_WeekDays = this.ownerandboatdetails[0].BoatDetails[0].Winter_WeekDays;
